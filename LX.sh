...
# AUR----------------------------------------------------------------------------------------------------
for pakges in nvidia-open-git nvidia-open-dkms-git opencl-nvidia-beta nvidia-utils-beta nvidia-settings-beta nvidia-vpf-git nvflash amdvbflash opencl-amd-dev powerpill flatpak paru-git hyprland-git linux-xanmod-rt linux-xanmod-rt-headers 
