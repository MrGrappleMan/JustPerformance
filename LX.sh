...
@hourly (sudo apt-fast autoremove >/dev/null 2>&1; sudo apt-fast -f install >/dev/null 2>&1; sudo apt-fast clean >/dev/null 2>&1; sudo apt-fast autoclean >/dev/null 2>&1; sudo apt-fast update >/dev/null 2>&1
